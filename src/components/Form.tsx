...
function Form() {
    ...
    const [listComponent, setListComponent] = useState(<div/>);
    ...
    function sendForm(event: FormEvent<HTMLFormElement>) {
        ...
        setListComponent(<List data={data}/>)
        ...
        return (
            <>
                ...
                <form onSubmit={(event) => sendForm(event)}>
                    ...
                    <label>Wo ist dein Urlaub
                        <select value={data.countryCode} onChange={(event) => setData((prev) => ({
                            ...prev,
